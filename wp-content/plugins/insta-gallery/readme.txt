...
This plugin was formerly known as "Instagram Feed Gallery". WordPress forced us on August 8, 2019, to change the name of the plugin due to the use of the "Instagram" word in the name.

[youtube https://www.youtube.com/watch?v=oiUpjrfqU84]

== Instagram Token setup ==

Social Feed Gallery offers a one-click setup, eliminating the need to create an app like other plugins require. Simply add your credentials, select an Instagram @id or #tags, click on the "Add New Account" button, and your Instagram access token will be automatically generated and saved.

== Social Feed Gallery Premium ==

Upgrade to Social Feed Gallery Premium to enjoy additional features, including:

* Multiple Instagram user accounts
* Masonry and highlight gallery layouts
* Boxed mode with colors and borders
* Display user profile avatar, username, and custom description
* Load more button
* And much more!

Check out the [Documentation](https://quadlayers.com/documentation/instagram-feed-gallery/) for more information on configuration possibilities.
...
2. Search for "Social Feed Gallery"
3. Click "Install"
4. Go to Social Feed Gallery / Account in your admin dashboard
5. Press the "Add new account" button and generate the access token
6. Go to Social Feed Gallery / Feeds and press the "Add new gallery" button
7. Configure your Social Feed Gallery
...
= 4.9.1 =
* Fix: Reload page after Instagram account token creation

= 4.9.0 =
* Refactor: improve emails handle & format
...
= 4.8.5 =
* Fix: Elementor loop widget

= 4.8.4 =
* Feat: Update Swiper carousel

= 4.8.3 =
* Fix: Remove unused code

= 4.8.2 =
* Fix: Instagram masonry layout 

= 4.8.1 =
* Fix: Instagram gallery layout width

= 4.8.0 =
* Fix: Load scripts only when its necessary
...
* Feat: Add create account button in feeds tab

= 4.7.2 =
* Fix: Restore Instagram feed responsive desktop setting
* Fix: Restore Instagram feed highlight padding
